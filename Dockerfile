...
RUN apt-get -qq update \
    && apt install -y software-properties-common qbittorrent-nox \
    ...
    && apt-get -qq install -y --no-install-recommends \
        ...
        unzip p7zip-full p7zip-rar aria2 curl pv jq ffmpeg curl wget locales python3-lxml xz-utils neofetch \
